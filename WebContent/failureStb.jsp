...
<h1><marquee scrollamount="15" onmouseover="this.stop();" onmouseout="this.start();">You have already purchased this setTopBox.<br>Please buy another type of SetTopBox.
</marquee></h1>
<br><br>
<!-----------------footer--------------------------------------------->
