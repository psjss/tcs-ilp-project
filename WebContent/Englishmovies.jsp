...
<!-- -----------------------------header ends here ---------------------------------- -->
<center>
<h1>English Movies Channels</h1><br><br>
<table>
		<div align = "center">
			<ul type="disc">
			<tr><td><li>HBO</li></td></tr>
			<tr><td><li>Star Movies</li></td></tr>
			<tr><td><li>Sony Pix</li></td></tr>
			<tr><td><li>W.B</li></td></tr>
			<tr><td><li>Romedy Now</li></td></tr>
			<tr><td><li>Zee Studio</li></td></tr>
