...
<form  method="post" action="Control">
			<br>
			<div align="center">
				<label>For Post-Paid : &nbsp;&nbsp;&nbsp;</label>
					<!--  <a href="CustId.jsp" target=_parent>-->
						<input type="submit" class="btn btn-success" name="billing" id="post" value="Generate Bill">
					</a>
				<br>
				</div>
				<br>
				...
				<div align="center">
				<label>For Pre-Paid : &nbsp;&nbsp;&nbsp;</label>
					<!--  <a href="CustId1.jsp" target=_parent>-->
						<input type="submit" class ="btn btn-success" name="billing" id="post" value="Deduct Bill">
					</a>
				<br>
				</div>
				</form>
