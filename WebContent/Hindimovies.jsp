...
<!-- -----------------------------header ends here ---------------------------------- -->
<center>
<h1>Hindi Movies Channels</h1><br><br>
<table>
		<div align = "center">
			<ul type="disc">
			<tr><td><li>Filmy</li></td></tr>
			<tr><td><li>Sony Max</li></td></tr>
			<tr><td><li>Star Gold</li></td></tr>
			<tr><td><li>Zee Cinema</li></td></tr>
			<tr><td><li>Movies OK</li></td></tr>
			<tr><td><li>UTV Movies</li></td></tr>
