...
<!-- -----------------------------header ends here ---------------------------------- -->
<center>
<h1>Sports HD Channels</h1><br><br>
<table>
		<div align = "center">
			<ul type="disc">
			<tr><td><li>Star SPorts1 HD</li></td></tr>
			<tr><td><li>Star SPorts2 HD</li></td></tr>
			<tr><td><li>Star SPorts3 HD</li></td></tr>
			<tr><td><li>Star SPorts4 HD</li></td></tr>
			<tr><td><li>Sony Espn HD</li></td></tr>
			<tr><td><li>Sony Six HD</li></td></tr>
			<tr><td><li>Ten Cricket HD</li></td></tr>
			<tr><td><li>Ten Sports HD</li></td></tr>
			<tr><td><li>Ten Action HD</li></td></tr>
			</ul>
			</div>
</table>	<br>
<button onclick="window.location.href='PurchaseChannelPack.jsp'" class="btn btn-success">Back</button>
			</center>
			<br><br>
<!-----------------footer--------------------------------------------->
