...
<div class="demo">
  <marquee behavior="scroll" style="background:#F3DB28; color:#000;" direction="left" onmouseover="this.stop();" onmouseout="this.start();">				
    Welcome &nbsp;<%=userName %> to Infinity DTH Experience the world of digital entertainment. Watch your favourite channels and experience the best of quality with Infinity .
  </marquee> 	 
</div>
<section>
