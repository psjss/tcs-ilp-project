...
<form action = "PurchaseStb" method = "post" name ="form" onsubmit="return validity()">
	<table align="center" border="5" cellpadding="2"  >
	
					<tr>
						<td >Select the type of bill payment &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td>
						<td ><input type="radio" name="billtype" value="Prepaid" >Prepaid
						 <input type="radio" name="billtype" value="Postpaid">Postpaid<br></td>
					</tr>
	...
	<div class="one-third column" >
			...
			<div class="eight columns">		
				<!-- Accordions -->
				<h2 class="title"><span>VIEW STB</span></h2>
				
				
					<div class="acc_item">
						<h4 class="accordion"><span class="acc_control"></span><span class="acc_heading">STB TYPES</span></h4>
						<div class="accordion_content">
						
						<fieldset>
					  
								<br>
								<h3> >>STANDARD</h3><input type = "radio" name = "stbtype" value = "Standard" >
								<table border="1" class="aqua_table responsive" width="50%">
								  <tbody>
								    <tr>
								       <th class="b"  bgcolor="mediumacquamarine" >Price</th>
								       <td class="b"  bgcolor="mediumacquamarine" >2000</td>	
								    </tr>
								    <tr>
								       <th bgcolor="gray">Features</th>
								       <td bgcolor="gray" >Multilingual Channel Guide</td>
								    <tr>
								       <th bgcolor="mediumacquamarine"></th>
								       <td bgcolor="mediumacquamarine" >Genre Wise Channel Guide</td>
								    </tr>
								</tbody></table>
								
								
								<br>
								<h3>>>IPTV</h3><input type = "radio" name = "stbtype" value = "IPTV">
								<table border="1" class="aqua_table responsive" width="50%">
								<tbody>
								  <tr>
								    <th class="b" bgcolor="mediumacquamarine">Price</th>
								    <td class="b" bgcolor="mediumacquamarine">2500</td>	
								  </tr>
								  <tr>
								    <th bgcolor="gray">Features</th>
								    <td bgcolor="gray">Multilingual Channel Guide</td>
								  ...
								  <tr>
								    <th bgcolor="gray"></th>
								    <td bgcolor="gray">Child Lock</td>
								  </tr>
								</tbody></table>
								
								<br>
								<h3> >>HD </h3><input type = "radio" name = "stbtype" value = "HD">
								<table border="1" class="aqua_table responsive" width="50%">
								<tbody>
								   <tr>
							 	     <th class="b" bgcolor="mediumacquamarine">Price</th>
								     <td class="b" bgcolor="mediumacquamarine">3500</td>	
								  </tr>
								  <tr>
								     <th bgcolor="gray">Features</th>
								     <td bgcolor="gray">Multilingual Channel Guide</td>
								  ...
								  <tr>
								     <th bgcolor="gray"></th>
								     <td bgcolor="gray">Scheduled Recording</td>
								  </tr>
								  <tr>
								     <th bgcolor="mediumacquamarine"></th>
								     <td bgcolor="mediumacquamarine">Pause and Play</td>
								  </tr>
								  <tr>
								     <th bgcolor="gray"></th>
								     <td bgcolor="gray">Rewind/Forward</td>
								  </tr>
								  <tr>
								     <th bgcolor="mediumacquamarine"></th>
								     <td bgcolor="mediumacquamarine">Slow Motion</td>
								  </tr>
								<tr>
								<th bgcolor="gray"></th>
								<td bgcolor="gray">Live Recording</td>
								</tr>
								</tbody></table>
								<br>
								<p align="left"><h3>>>HD+</h3><input type = "radio" name = "stbtype" value = "HD+">
						<table border="1" class="aqua_table responsive" width="50%">
								<tbody>
								<tr>
								<th class="b" bgcolor="mediumacquamarine">Price</th>
								<td class="b" bgcolor="mediumacquamarine">4000</td>	
								</tr>
								<tr>
								<th bgcolor="gray">Features</th>
								<td bgcolor="gray">Multilingual Channel Guide</td>
								...
								<tr>
								<th bgcolor="mediumacquamarine"></th>
								<td bgcolor="mediumacquamarine">Child Lock</td>
								</tr>
								</tbody></table>
								</fieldset>
						</div>
			...
			<br><br>
				<input type="submit"  class="btn btn-success " name = "purchaseStb" value = "Purchase STB"/>
