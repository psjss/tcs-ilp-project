        ...
        <ul class="nav navbar-nav nav_1">
            ...
            <li><a href="PurchaseStb.jsp">Purchase STB</a></li>
                <li><a href="welecomeuser.jsp">Purchase Package</a></li>
                  <li><a href="welecomeuser.jsp">Bill Details</a></li>
...
<form action="PurchaseController" name="myform" method="post" onsubmit="return valide()">
<br>
   <div align="center">
   ...
   <%try
   {
	   if(!list.isEmpty()){
		   String s1 = null;%>
			...
			Set top box Id : &nbsp;&nbsp;<select name="stbid">
				<%for(String s:list)
					{ %>
			...
			<br><br><br>
			<table border="1"><fieldset>
				<h2><span>CHANNEL PACKAGE </span></h2>
				<br><br><br>
					<h4>SPORTS</h4>	
					 <table  border="2"class="aqua_table responsive" width="28%" bordercolor="green">
					<tr>
					<td  bgcolor="#ececf9"><div><input  type="checkbox" name=pack value="1"><a href="Sports.jsp"><span class="pull-">SPORTS CHANNELS @Rs.50/month</span></a></div>
					</td>
					</tr>
					<tr>
					<td>
					<div><input type="checkbox" name=pack value="2"><a href="Sportshd.jsp">SPORTS HD @Rs.50/month</a></div>
					</td>
					</tr>
					</table>
					<br>
					...
					<h4>MOVIES</h4>	
					 <table border="2" class="aqua_table responsive" width="28%" bordercolor="green">
							<tr>
					<td bgcolor="#ececf9"><div><input type="checkbox" name=pack value="3"><a href="Englishmovies.jsp">English Movies @Rs.50/month</a></div>
					</td>
					</tr>
						    <tr>
					<td><div><input type="checkbox" name=pack value="4"><a href="Hindimovies.jsp">Hindi Movies @Rs.50/month</a></div>
					</td></tr></table>
					<br>
					<br>
					...
					<br><br>
					<table border="2" class="aqua_table responsive" width="28%" bordercolor="green">
			<h4>Select Sports HD Channels</h4>
			<tr>
					<td bgcolor="#ececf9">
				<div><input type="checkbox"  name="tel" value=1>Star Sports HD1</div>
				</td></tr>
				<tr><td>
			    <div><input type="checkbox"  name="tel" value=2>Star Sports HD2</div></td></tr>
				<tr><td bgcolor="#ececf9"><div><input type="checkbox"  name="tel" value=3>Star Sports HD3</div></td></tr>
				<tr><td><div><input type="checkbox"  name="tel" value=4>Star Sports HD4</div></td></tr></table>
			          <br>
			          <br>
			
	
			<h4>Select Kids Cartoon Channels</h4>
			<table border="2" class="aqua_table responsive" width="28%" bordercolor="green">
				<tr><td bgcolor="#ececf9"><div><input type="checkbox"  name="tel" value=5>Pogo</div></td></tr>
			    <tr><td><div><input type="checkbox"  name="tel" value=6>Cartoon Network</div></td></tr>
			   <tr><td bgcolor="#ececf9"> <div><input type="checkbox"  name="tel" value=7>Discovery Kids</div></td></tr></table>
			          <br>
			          <br>
					
					
				<div><input type="submit"  class="btn btn-success " value = "submit" name = "submit"/></div><br><br>
